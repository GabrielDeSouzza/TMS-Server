...
abstract class WhereLegalClientQuoteTableTypeDTO extends WhereDTO {
  id?: StringFilterDTO;
...
abstract class SortByLegalClientQuoteTableTypeDTO {
  id?: 'asc' | 'desc';
  cod_quote?: 'asc' | 'desc';
...
export class FindAllLegalClientQuoteTableWhereRequestDTO {
  limit: number;
  offset: number;
