...
export abstract class WhereOrderProcessingLegalClientTypeDTO extends WhereDTO {
  id?: StringFilterDTO;
...
export abstract class SortByOrderProcessingLegalClientTypeDTO {
  id?: 'asc' | 'desc';
...
export class FindAllOrderProcessingLegalClientWhereRequestDTO {
  limit: number;
  offset: number;
  sort?: SortByOrderProcessingLegalClientTypeDTO;
  where?: WhereOrderProcessingLegalClientTypeDTO;
}
