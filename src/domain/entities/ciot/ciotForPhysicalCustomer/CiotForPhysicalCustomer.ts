...
import { type PhysicalCustomer } from '../../clients/physicalCustomer/PhysicalCustomer';
import { type PhysicalContractor } from '../../contractors/physicalContractor/PhysicalContractor';
...
export class CiotForPhysicalCustomer extends Entity {
  ...
  validate() {
    ...
    this.props.PhysicalContractor.validate();
