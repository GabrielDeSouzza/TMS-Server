import { PhysicalCustomer } from 'domain/entities/clients/physicalCustomer/PhysicalCustomer';
import { PhysicalContractor } from 'domain/entities/contractors/physicalContractor/PhysicalContractor';
