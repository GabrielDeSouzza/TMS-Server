...
export interface IPhysicalCustomerCte {
  id?: string;
  orderId: string;
  acessKey: string;
  observations?: string;
...
export class PhysicalCustomerCte extends Entity {
  private props: IPhysicalCustomerCte;

  constructor(props: IPhysicalCustomerCte) {
    super();
