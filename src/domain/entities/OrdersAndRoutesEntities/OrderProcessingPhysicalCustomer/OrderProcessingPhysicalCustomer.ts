...
export interface IOrderProcessingPhysicalCustomer {
  id?: string;
...
export class OrderProcessingPhysicalCustomer extends Entity {
  private props: IOrderProcessingPhysicalCustomer;

  constructor(
    props: Replace<
      IOrderProcessingPhysicalCustomer,
